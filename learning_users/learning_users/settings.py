...
SECRET_KEY = '5_k^6_%oj=@_%4+1^^06noyjz2*ns38ux&u*9mnn42bkj&stpf'
...
# Layers of password hash security
PASSWORD_HASHERS = [
...
# Check for minimum length (9), common passwords, and similarity to user name
